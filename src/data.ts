...
export const INITIAL_PROJECTS: APKProject[] = [
  ...
  // },
  {
    ...
    title: 'Learn Persian',
    version: 'v1.0.0',
    description: 'Master the Persian alphabet through a fun 3D adventure.',
    longDescription:
      'Learn Persian turns alphabet practice into a playable 3D world. Hear each letter pronounced, run around a Persian-inspired stage, jump onto floating letter spots, and pick the right character before the level gets harder. Built with React Three Fiber, Rapier physics, and audio feedback so learning feels like a game instead of flashcards.',
    category: 'Education',
    framework: 'React Three Fiber',
    tags: ['REACT', 'THREE.JS', 'RAPIER', 'ZUSTAND', 'WEBGL', 'PERSIAN'],
    size: '~25 MB',
    minApi: 'Modern browser (WebGL 2)',
    updatedAt: 'Freshly wired',
    license: 'MIT',
    downloads: 0,
    status: 'Live',
    screenshotUrl: '/images/learnPersianImage.png',
    screenshotFit: 'cover',
    screenshotScale: 100,
    screenshotXOffset: 0,
    screenshotYOffset: 0,
    coverUrl: '/images/mainImg.png',
    projectType: 'website',
    siteUrl: 'https://learn-persian.vercel.app',
    previewFrame: 'desktop',
    iconType: 'vibe',
    worksGreat: [
      '32 Persian letters with isolated forms, transliteration, and pronunciation audio.',
      '5-stage runs that get harder — more letter choices each stage.',
      'Smooth 3D movement with WASD / arrow keys and Space to jump.',
      'Animated seagull character on a Persepolis-inspired stage.',
      'Instant audio feedback on correct and wrong answers.',
    ],
    spontaneousFeatures: [
      'A rotating kicker bar appears from stage 3 onward to keep you on your toes.',
      'Wrong picks show the mistaken letter in red on the floor — very judgmental, very educational.',
      'The seagull might judge your letter choices. We cannot confirm, but the vibe is there.',
    ],
    mascotQuote:
      'Salam! Jump on the right letter, ignore the wrong ones, and maybe one day you will read Hafez without Google Translate.',
  },
  {
    id: 'guilt-giver',
    title: 'Guilt Giver',
